 ...
 *  epos_event_receive directive to determine which events are pending.
 */
...
/**
 *  @brief epos_event_send
 *
 *  This routine implements the epos_event_send directive.  It sends
...
/**
 *  @brief epos_event_receive
 *
 *  This routine implements the epos_event_receive directive.  This
 ...
 *  event_out parameter.
 */
epos_status_code epos_event_receive (
  epos_event_set  event_in,
  epos_option     option_set,
  epos_interval   ticks,
  epos_event_set *event_out
);
