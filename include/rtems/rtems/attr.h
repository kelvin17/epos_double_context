 ...
 */
typedef uint32_t   epos_attribute;
...
#define ATTRIBUTES_REQUIRED            0
	...
	RTEMS_INLINE_ROUTINE epos_attribute _Attributes_Set (epos_attribute new_attributes,epos_attribute attribute_set);

	RTEMS_INLINE_ROUTINE epos_attribute _Attributes_Clear (epos_attribute attribute_set,epos_attribute mask);
	...
	RTEMS_INLINE_ROUTINE bool _Attributes_Is_simple_binary_semaphore(epos_attribute attribute_set);

	RTEMS_INLINE_ROUTINE bool _Attributes_Is_counting_semaphore(epos_attribute attribute_set);

	RTEMS_INLINE_ROUTINE bool _Attributes_Is_inherit_priority(epos_attribute attribute_set);

	RTEMS_INLINE_ROUTINE bool _Attributes_Is_priority_ceiling(epos_attribute attribute_set);

	RTEMS_INLINE_ROUTINE bool _Attributes_Is_barrier_automatic(epos_attribute attribute_set);

	RTEMS_INLINE_ROUTINE bool _Attributes_Is_system_task(epos_attribute attribute_set);
