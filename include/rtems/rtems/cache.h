 ...
 */
void epos_cache_flush_multiple_data_lines( const void *, size_t );
 ...
 */
void epos_cache_invalidate_multiple_data_lines( const void *, size_t );

/**
 * This function is responsible for performing a data cache flush.
 * It flushes the entire cache.
 */
void epos_cache_flush_entire_data( void );

/**
 * This function is responsible for performing a data cache
 * invalidate. It invalidates the entire cache.
 */
void epos_cache_invalidate_entire_data( void );

/**
 * This function returns the data cache granularity.
 */
int epos_cache_get_data_line_size( void );

/**
 * This function freezes the data cache.
 */
void epos_cache_freeze_data( void );

/**
 * This function unfreezes the data cache.
 */
void epos_cache_unfreeze_data( void );

/**
 * This function enables the data cache.
 */
void epos_cache_enable_data( void );

/**
 * This function disables the data cache.
 */
void epos_cache_disable_data( void );
 ...
 */
void epos_cache_invalidate_multiple_instruction_lines( const void *, size_t );

/**
 * This function is responsible for performing an instruction cache
 * invalidate. It invalidates the entire cache.
 */
void epos_cache_invalidate_entire_instruction( void );

/**
 * This function returns the instruction cache granularity.
 */
int epos_cache_get_instruction_line_size( void );

/**
 * This function freezes the instruction cache.
 */
void epos_cache_freeze_instruction( void );

/**
 * This function unfreezes the instruction cache.
 */
void epos_cache_unfreeze_instruction( void );

/**
 * This function enables the instruction cache.
 */
void epos_cache_enable_instruction( void );

/**
 * This function disables the instruction cache.
 */
void epos_cache_disable_instruction( void );
