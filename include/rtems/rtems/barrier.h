 ...
 *
 *  @brief RTEMS Barrier(障碍/同步点)管理服务模块。
 *
...
/**
 *  @brief epos_barrier_create
 *
 *  This routine implements the epos_barrier_create directive.  The
 ...
 */
epos_status_code epos_barrier_create(
  epos_name           name,
  epos_attribute      attribute_set,
...
/**
 *  @brief epos_barrier_ident
 *
 *  This routine implements the epos_barrier_ident directive.
 ...
 *  @return a status code indicating success or the reason for failure.
 */
epos_status_code epos_barrier_ident(
  epos_name    name,
  epos_id     *id
);

/**
 *  @brief epos_barrier_delete
 *
 *  This routine implements the epos_barrier_delete directive.  The
...
/**
 *  @brief epos_barrier_wait
 *
 *  This routine implements the epos_barrier_wait directive.  It
 ...
 *  @return a status code indicating success or the reason for failure.
 */
epos_status_code epos_barrier_wait(
  epos_id       id,
  epos_interval timeout
);

/**
 *  @brief epos_barrier_release
 *
 *  This routine implements the epos_barrier_release directive.  It
 ...
 *  @return a status code indicating success or the reason for failure.
 */
epos_status_code _Barrier_Translate_core_barrier_return_code (
