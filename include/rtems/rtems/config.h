 ...
 *
 *  @brief EPOS API Configuration Table Definition.
 *
...
typedef struct {
   ...
   * Tasks which are configured for this application.
   */
  epos_initialization_tasks_table *User_initialization_tasks_table;
} epos_api_configuration_table;
 ...
 *  by confdefs.h.
 */
extern epos_api_configuration_table Configuration_RTEMS_API;
 ...
 */
#define epos_configuration_get_notepads_enabled() \
        epos_configuration_get_epos_api_configuration()->notepads_enabled

/**
 *  This macro returns the number of Classic API semaphores configured.
 */
#define epos_configuration_get_maximum_semaphores() \
        epos_configuration_get_epos_api_configuration()->maximum_semaphores
