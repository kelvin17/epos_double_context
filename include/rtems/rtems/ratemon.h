 ...
 *  used by the owning thread between successive calls to epos_rate_monotonic_period.
 */
/**@{*/
 ...
 */
  ...
  typedef struct timespec epos_rate_monotonic_period_time_t;
#else
  typedef uint32_t epos_rate_monotonic_period_time_t;
#endif
...
}   epos_rate_monotonic_period_states;
...
typedef struct {
  ...
  epos_thread_cpu_usage_t             min_cpu_time;
  /** This field contains the highest amount of CPU time used in a period. */
  epos_thread_cpu_usage_t             max_cpu_time;
  /** This field contains the total amount of wall time used in a period. */
  epos_thread_cpu_usage_t             total_cpu_time;

  /** This field contains the least amount of wall time used in a period. */
  epos_rate_monotonic_period_time_t   min_wall_time;
  /** This field contains the highest amount of wall time used in a period. */
  epos_rate_monotonic_period_time_t   max_wall_time;
  /** This field contains the total amount of CPU time used in a period. */
  epos_rate_monotonic_period_time_t   total_wall_time;
}  epos_rate_monotonic_period_statistics;
...
typedef struct {
  ...
  epos_rate_monotonic_period_states   state;
   ...
   */
  epos_rate_monotonic_period_time_t   since_last_period;
   ...
   *  then this field has no meaning.
   */
  epos_thread_cpu_usage_t             executed_since_last_period;
}  epos_rate_monotonic_period_status;
...
/**
 *  @brief epos_rate_monotonic_create
 *
 ...
 */
epos_status_code epos_rate_monotonic_create(
  epos_name    name,
  epos_id     *id
);

/**
 *  @brief epos_rate_monotonic_ident
 *
 *  This routine implements the epos_rate_monotonic_ident directive.
 ...
 */
epos_status_code epos_rate_monotonic_ident(
  epos_name    name,
  epos_id     *id
);

/**
 *  @brief epos_rate_monotonic_cancel
 *
 *  This routine implements the epos_rate_monotonic_cancel directive.  This
 *  directive stops the period associated with ID from continuing to
 *  run.
 */
epos_status_code epos_rate_monotonic_cancel(
  epos_id   id
);

/**
 *  @brief epos_rate_monotonic_delete
 *
 *  This routine implements the epos_rate_monotonic_delete directive.  The
 *  period indicated by ID is deleted.
 */
epos_status_code epos_rate_monotonic_delete(
  epos_id   id
);

/**
 *  @brief epos_rate_monotonic_get_status
 *
 *  This routine implements the epos_rate_monotonic_get_status directive.
 *  Information about the period indicated by ID is returned.
 *
 */
epos_status_code epos_rate_monotonic_get_status(
  epos_id                             id,
  epos_rate_monotonic_period_status  *status
);

/**
 *  @brief epos_rate_monotonic_get_statistics
 *
 *  This routine implements the epos_rate_monotonic_get_statistics directive.
 *  Statistics gathered from the use of this period are returned.
 */
epos_status_code epos_rate_monotonic_get_statistics(
  epos_id                                id,
  epos_rate_monotonic_period_statistics *statistics
);

/**
 *  @brief epos_rate_monotonic_reset_statistics
 *
 *  This routine allows a thread to reset the statistics information
 *  on a specific period instance.
 */
epos_status_code epos_rate_monotonic_reset_statistics(
  epos_id                                 id
);

/**
 *  @brief epos_rate_monotonic_reset_all_statistics
 *
 *  This routine allows a thread to reset the statistics information
...
/**
 *  @brief epos_rate_monotonic_report_statistics
 *
 *  This routine allows a thread to print the statistics information
 *  on ALL period instances which have non-zero counts using printk.
 */
void epos_rate_monotonic_report_statistics_with_plugin(
  void                  *context,
 ...
 *  on ALL period instances which have non-zero counts using printk.
 */
void epos_rate_monotonic_report_statistics( void );

/**
 *  @brief epos_rate_monotonic_period
 *
 *  This routine implements the epos_rate_monotonic_period directive.  When
 ...
 */
epos_status_code epos_rate_monotonic_period(
  epos_id        id,
  epos_interval  length
);
 ...
 *  call to epos_rate_monotonic_period for the period's first iteration
...
#define _Rate_monotonic_Reset_statistics( _the_period ) \
  do { \
    memset( \
      ...
      0, \
      sizeof( epos_rate_monotonic_period_statistics ) \
    ); \
