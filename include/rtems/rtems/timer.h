 ...
 */
typedef void epos_timer_service_routine;
 ...
 */
typedef epos_timer_service_routine ( *epos_timer_service_routine_entry )(
                 epos_id,
                 void *
             );
...
/**
 *  @brief epos_timer_create
 *
 *  This routine implements the epos_timer_create directive.  The
 *  timer will have the name name.  It returns the id of the
 *  created timer in ID.
 */
epos_status_code epos_timer_create(
  epos_name    name,
  epos_id     *id
);

/**
 *  @brief epos_timer_ident
 *
 *  This routine implements the epos_timer_ident directive.
...
/**
 *  @brief epos_timer_cancel
 *
 *  This routine implements the epos_timer_cancel directive.  It is used
 *  to stop the timer associated with ID from firing.
 */
epos_status_code epos_timer_cancel(
  epos_id   id
);

/**
 *  @brief epos_timer_delete
 *
 *  This routine implements the epos_timer_delete directive.  The
 *  timer indicated by ID is deleted.
 */
epos_status_code epos_timer_delete(
  epos_id   id
);

/**
 *  @brief epos_timer_fire_after
 *
 *  This routine implements the epos_timer_fire_after directive.  It
 ...
 *  of the epos_clock_tick directive which is normally invoked as
 *  part of servicing a periodic interupt.
 */
epos_status_code epos_timer_fire_after(
  epos_id                           id,
  epos_interval                     ticks,
...
/**
 *  @brief epos_timer_server_fire_after
 *
 *  This routine implements the epos_timer_server_fire_after directive.  It
...
/**
 *  @brief epos_timer_fire_when
 *
 *  This routine implements the epos_timer_fire_when directive.  It
...
/**
 *  @brief epos_timer_server_fire_when
 *
 *  This routine implements the epos_timer_server_fire_when directive.  It
 *  initiates the timer associated with ID to fire at wall_time
 *  When the timer fires, the routine will be invoked by the
 *  Timer Server in the context of a task NOT IN THE CONTEXT of the
 *  clock tick interrupt.
 */
epos_status_code epos_timer_server_fire_when(
  epos_id                            id,
  epos_time_of_day                  *wall_time,
  epos_timer_service_routine_entry   routine,
  void                               *user_data
...
/**
 *  @brief epos_timer_reset
 *
 *  This routine implements the epos_timer_reset directive.  It is used
 *  to reinitialize the interval timer associated with ID just as if
 *  epos_timer_fire_after were re-invoked with the same arguments that
 *  were used to initiate this timer.
 */
epos_status_code epos_timer_reset(
  epos_id   id
);

/**
 *  @brief epos_timer_initiate_server
 *
 *  This routine implements the epos_timer_initiate_server directive.
 *  It creates and starts the server that executes task-based timers.
 *  It must be invoked before any task-based timers can be initiated.
 */
epos_status_code epos_timer_initiate_server(
  uint32_t             priority,
  uint32_t             stack_size,
...
} epos_timer_information;

/**
 *  @brief epos_timer_get_information
 *
 *  This routine implements the epos_timer_get_information directive.
