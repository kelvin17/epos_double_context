 ...
 *
 *  @brief RTEMS ASR (Ashychronous Signal Roution)管理服务模块。
 *
...
RTEMS_INLINE_ROUTINE bool _ASR_Is_null_handler (epos_asr_entry asr_handler);

RTEMS_INLINE_ROUTINE bool _ASR_Are_signals_pending (ASR_Information *information);

RTEMS_INLINE_ROUTINE void _ASR_Post_signals(epos_signal_set  signals,epos_signal_set *signal_set);
