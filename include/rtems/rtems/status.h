...
const epos_status_code _Status_Object_name_errors_to_status[] = {
...
#else
extern epos_status_code _Status_Object_name_errors_to_status[];
#endif
...
RTEMS_INLINE_ROUTINE bool epos_is_status_successful(
  epos_status_code code
);
RTEMS_INLINE_ROUTINE bool epos_are_statuses_equal(
  epos_status_code code1,
  epos_status_code code2
);
