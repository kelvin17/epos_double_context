...
/**
 *  @brief epos_semaphore_create
 *
 *  This routine implements the epos_semaphore_create directive.  The
 ...
 */
epos_status_code epos_semaphore_create(
  epos_name           name,
  uint32_t             count,
  epos_attribute      attribute_set,
  epos_task_priority  priority_ceiling,
  epos_id            *id
);

/**
 *  @brief epos_semaphore_ident
 *
 *  This routine implements the epos_semaphore_ident directive.
 ...
 *  encompass all nodes.
 */
epos_status_code epos_semaphore_ident(
  epos_name    name,
  uint32_t      node,
  epos_id     *id
);
...
/**
 *  @brief epos_semaphore_delete
 *
 *  This routine implements the epos_semaphore_delete directive.  The
...
/**
 *  @brief epos_semaphore_obtain
 *
 *  This routine implements the epos_semaphore_obtain directive.  It
 ...
 */
epos_status_code epos_semaphore_obtain(
  epos_id       id,
...
/**
 *  @brief epos_semaphore_release
 *
 *  This routine implements the epos_semaphore_release directive.  It
 ...
 */
epos_status_code _Semaphore_Translate_core_mutex_return_code (
 ...
 *  status code specified.
 */
epos_status_code _Semaphore_Translate_core_semaphore_return_code (
  uint32_t   the_mutex_status
);
