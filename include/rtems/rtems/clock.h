...
/**
 *  List of things which can be returned by the epos_clock_get directive.
 */
typedef enum {
 ...
 *
 *  This routine implements the epos_clock_get_tod directive.  It returns
 ...
 *
 *  This routine implements the epos_clock_get_tod_timeval
 *  directive.
 *
 ...
 *
 *  This routine implements the epos_clock_get_seconds_since_epoch
 *  directive.
 *
 ...
 *
 *  This routine implements the epos_clock_get_ticks_since_boot
 *  directive.
 *
 ...
 */
epos_interval epos_clock_get_ticks_since_boot(void);

/**
 *  @brief Obtain Ticks Per Seconds
 *
 *  This routine implements the epos_clock_get_ticks_per_second
 *  directive.
 *
 *  @return This method returns the number of ticks since boot.  It cannot
 ...
 *
 *  This routine implements the epos_clock_set directive.  It sets
 ...
 *
 *  This routine implements the epos_clock_tick directive.  It is invoked
 ...
 */
epos_status_code epos_clock_tick( void );
 ...
 *          filled in.
 */
epos_status_code epos_clock_get_uptime(
 ...
 */
bool _TOD_Validate(
  const epos_time_of_day *the_tod
);
