 ...
 */
typedef ISR_Level epos_interrupt_level;

/**
 *  @brief Control block type used to manage the vectors.
 */
typedef ISR_Vector_number epos_vector_number;

/**
 *  @brief Return type for interrupt handler.
 */
typedef void epos_isr;

/**
 *  @brief Interrupt handler type.
 *
 *  @see epos_interrupt_catch()
 */
typedef epos_isr ( *epos_isr_entry )(
                 epos_vector_number
             );

#if (CPU_SIMPLE_VECTORED_INTERRUPTS == TRUE)
/**
 *  @brief Implementation of the epos_interrupt_catch directive.
 *
 ...
 */
epos_status_code epos_interrupt_catch(
  epos_isr_entry      new_isr_handler,
  epos_vector_number  vector,
  epos_isr_entry     *old_isr_handler
);
#endif
 ...
 *  @a _isr_cookie.
 *
 *  @note The interrupt level shall be of type @ref epos_interrupt_level.
 */
#define epos_interrupt_disable( _isr_cookie ) \
 ...
 *  @note The interrupt level shall be of type @ref epos_interrupt_level.
 */
#define epos_interrupt_enable( _isr_cookie ) \
 ...
 *  @note The interrupt level shall be of type @ref epos_interrupt_level.
 */
#define epos_interrupt_flash( _isr_cookie ) \
 ...
 */
#define epos_interrupt_is_in_progress() \
    _ISR_Is_in_progress()
 ...
 */
#define epos_interrupt_cause( _interrupt_to_cause )
 ...
 *  @note No implementation.
 */
#define epos_interrupt_clear( _interrupt_to_clear )
