 ...
 *  @file  priority.h
 *
 *  @ingroup ScorePriority
 *
 *  @brief Header file of all thread priority manipulation routines.
 *
...
#define PRIORITY_MAXIMUM      epos_maximum_priority
...
extern uint8_t epos_maximum_priority;
