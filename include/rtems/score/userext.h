 ...
 *
 * @brief Header file of The User Extension Handler API.
 */
 ...
 *
 * It corresponds to _Thread_Initialize() (used by the epos_task_create()
 ...
 *
 * It corresponds to _Thread_Close() (used by the epos_task_delete()
 * directive).  The first parameter points to the currently executing thread
 ...
 *
 * It corresponds to _Thread_Start() (used by the epos_task_start()
 * directive).  The first parameter points to the currently executing thread
 ...
 *
 * It corresponds to _Thread_Restart() (used by the epos_task_restart()
 * directive).  The first parameter points to the currently executing thread
 ...
 * epos_fatal_error_occurred() directive).  The first parameter contains the
