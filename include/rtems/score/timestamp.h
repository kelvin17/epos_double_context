 ...
 *  @file  timestamp.h
 *
 *  @ingroup ScoreTimestamp
 *
 *  @brief Header file of the timestamps.
 *
...
/**
 *  @defgroup ScoreTimestamp SuperCore Timestamp
 *
 *  @ingroup Score
 *
 *  @brief 核心抽象层之Timestamp抽象管理模块
 *
...
#define CPU_RTEMS_SCORE_TIMESTAMP_IS_STRUCT_SPEC/*by zwj, use this*/
 ...
 */
#ifdef CPU_RTEMS_SCORE_TIMESTAMP_IS_STRUCT_SPEC
