 ...
 * @ingroup ScoreCPU
 *
 *  @brief Header file of the Object handler.
 *
 ...
 *
 * @brief 核心抽象层：为所有的API提供各种抽象和服务。(Provides services for all APIs.)
 */
 ...
 * @ingroup Score
 *
 *  @brief 核心抽象层之CPU抽象管理模块：Provides CPU architecture dependent services.
 */
...
//  uint32_t    name_u32;
//} Objects_Name;
typedef uint32_t Objects_Name;/////////////////////////saved
