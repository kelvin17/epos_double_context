 ...
 *  @ingroup ScoreStack
 *
 *  @brief The include file of the thread stack handler.
 *
...
# error "Never use "stack.inl" directly; include "stack.h" instead."
#endif
...
{
  the_stack->old_area = the_stack->area;
...
{
  return epos_minimum_stack_size;
}
