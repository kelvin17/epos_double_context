 ...
 */
#define epos_set_errno_and_return_minus_one( _error ) \
 ...
 *
 *  @note It is similar to @ref epos_set_errno_and_return_minus_one but
 *        this -1 value is cast to something other than an int.
 */
#define epos_set_errno_and_return_minus_one_cast( _error, _cast ) \
