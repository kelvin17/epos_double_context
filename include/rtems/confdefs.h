...
#define CONFIGURE_LIBIO_SEMAPHORES \
   ...
   */
  uint32_t epos_libio_number_iops = CONFIGURE_LIBIO_MAXIMUM_FILE_DESCRIPTORS;
#endif
 ...
 */
#ifdef CONFIGURE_INIT
  int epos_telnetd_maximum_ptys = CONFIGURE_MAXIMUM_PTYS;
#else
  extern int epos_telnetd_maximum_ptys;
#endif
 ...
 */ 
   ...
   */
    ...
    const epos_filesystem_table_t epos_filesystem_table[] = {
   ...
   */
      ...
      bool epos_pipe_configured = true;
    #else
      bool epos_pipe_configured = false;
    #endif
  #endif

  #ifndef CONFIGURE_HAS_OWN_MOUNT_TABLE
    const epos_filesystem_mount_table_t configuration_mount_table = {
      #if defined(CONFIGURE_USE_DEVFS_AS_BASE_FILESYSTEM)
    ...
    const epos_filesystem_mount_table_t
        *epos_filesystem_mount_table = &configuration_mount_table;
const  int epos_filesystem_mount_table_size = 1;
  #endif
 ...
 */
  ...
  #define CONFIGURE_MINIMUM_TASK_STACK_SIZE 4096	//CPU_STACK_MINIMUM_SIZE
#endif
...
#include <rtems/malloc.h>
   ...
   */
  epos_malloc_statistics_functions_t *epos_malloc_statistics_helpers =
   ...
   */
  epos_malloc_sbrk_functions_t *epos_malloc_sbrk_helpers =
    #ifndef CONFIGURE_MALLOC_BSP_SUPPORTS_SBRK
      NULL;
    #else
      &epos_malloc_sbrk_helpers_table;
    #endif
#endif
   ...
   *  problems.
   */
  epos_malloc_dirtier_t epos_malloc_dirty_helper =
    #if defined(CONFIGURE_MALLOC_DIRTY)
      epos_malloc_dirty_memory;
    #else
      NULL;
    #endif
#endif
 ...
 */
  ...
  #define CONFIGURE_INIT_TASK_NAME          epos_build_name('U', 'I', '1', ' ')
#endif
  ...
  extern "C" {
  #endif
    epos_task Init (epos_task_argument );
  #ifdef __cplusplus
  }
  #endif
  #define CONFIGURE_INIT_TASK_ENTRY_POINT   Init
  extern const char* bsp_boot_cmdline;
  #define CONFIGURE_INIT_TASK_ARGUMENTS     ((epos_task_argument) &bsp_boot_cmdline)
#endif
...
#ifdef CONFIGURE_INIT
  epos_initialization_tasks_table Initialization_tasks[] = {
...
#define CONFIGURE_INIT_TASK_TABLE_SIZE \
  sizeof(CONFIGURE_INIT_TASK_TABLE) / sizeof(epos_initialization_tasks_table)
...
#define NULL_DRIVER_TABLE_ENTRY \
 { NULL, NULL, NULL, NULL, NULL, NULL }
  ...
  #include <bsp/drivers/timerdrv.h>
#endif

#ifdef CONFIGURE_APPLICATION_NEEDS_RTC_DRIVER
  #include <bsp/drivers/rtc.h>
#endif

#ifdef CONFIGURE_APPLICATION_NEEDS_WATCHDOG_DRIVER
  #include <bsp/drivers/watchdogdrv.h>
#endif

#ifdef CONFIGURE_APPLICATION_NEEDS_FRAME_BUFFER_DRIVER
  #include <bsp/drivers/framebuffer.h>
#endif
...
#ifdef CONFIGURE_INIT
  epos_driver_address_table Device_drivers[] = {
...
#define CONFIGURE_NUMBER_OF_DRIVERS \
  ((sizeof(Device_drivers) / sizeof(epos_driver_address_table)))
 ...
 */
  ...
  #endif
  #ifdef CONFIGURE_INIT
    epos_task_priority epos_ata_driver_task_priority
 ...
 */
   ...
   */
    ...
    #define CONFIGURE_MEMORY_FOR_TASK_VARIABLES(_task_variables) \
      (_task_variables) * \
         _Configure_From_workspace(sizeof(epos_task_variable_t))
  #endif
   ...
   */
    ...
    #define CONFIGURE_MICROSECONDS_PER_TICK \
            RTEMS_MILLISECONDS_TO_MICROSECONDS(100)		//100ms
  #endif
...
#include <rtems/libcsupport.h>
  ...
  epos_extensions_table Configuration_Initial_Extensions[] = {
...
(( \
   ...
   */
  epos_api_configuration_table Configuration_RTEMS_API = {
    CONFIGURE_MAXIMUM_TASKS,
   ...
   */
  uint32_t epos_minimum_stack_size =512;
  //  CONFIGURE_MINIMUM_TASK_STACK_SIZE;
   ...
   *        include the full configuration table.
   */
  uint8_t epos_maximum_priority = CONFIGURE_MAXIMUM_PRIORITY;
