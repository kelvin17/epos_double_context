...
typedef User_extensions_routine
  epos_extension RTEMS_COMPILER_DEPRECATED_ATTRIBUTE;
 ...
 * epos_initialize_data_structures() directive. The static extension set is
 ...
 * epos_extension_create() directive. These extensions are RTEMS objects in
 ...
 * and installed after the epos_initialize_data_structures() directive
 ...
 *
 * @code
 * epos_tcb *task = some_task;
 * size_t index = epos_object_id_get_index(extension_id);
...
typedef User_extensions_thread_create_extension   epos_task_create_extension;
typedef User_extensions_thread_delete_extension   epos_task_delete_extension;
typedef User_extensions_thread_start_extension    epos_task_start_extension;
typedef User_extensions_thread_restart_extension  epos_task_restart_extension;
typedef User_extensions_thread_switch_extension   epos_task_switch_extension;
typedef User_extensions_thread_begin_extension    epos_task_begin_extension;
typedef User_extensions_thread_exitted_extension  epos_task_exitted_extension;
typedef User_extensions_fatal_extension           epos_fatal_extension;

typedef User_extensions_Table                     epos_extensions_table;
