...
static inline epos_vector_number bsp_interrupt_handler_index(
 ...
 * compatibility:
 * - BSP_get_current_epos_irq_handler()
 * - BSP_install_epos_irq_handler()
 * - BSP_install_epos_shared_irq_handler()
 * - BSP_remove_epos_irq_handler()
 * - BSP_epos_irq_mngt_set()
 * - BSP_epos_irq_mngt_get()
 *
 * @{
 */
 ...
 */
static inline bool bsp_interrupt_is_valid_vector(epos_vector_number vector)
{
  return (epos_vector_number) BSP_INTERRUPT_VECTOR_MIN <= vector
    && vector <= (epos_vector_number) BSP_INTERRUPT_VECTOR_MAX;
}
 ...
 */
void bsp_interrupt_handler_default(epos_vector_number vector);
 ...
 */
epos_status_code bsp_interrupt_initialize(void);
 ...
 */
epos_status_code bsp_interrupt_facility_initialize(void);
 ...
 * @return On success RTEMS_SUCCESSFUL shall be returned.
 */
epos_status_code bsp_interrupt_vector_enable(epos_vector_number vector);
 ...
 * @return On success RTEMS_SUCCESSFUL shall be returned.
 */
epos_status_code bsp_interrupt_vector_disable(epos_vector_number vector);
 ...
 */
static inline void bsp_interrupt_handler_dispatch(epos_vector_number vector)
{
