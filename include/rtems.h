 ...
 *
 * @brief score service layer:include all kinds of services And API from Rtems (RTEMS Classic API definitions and modules.)
 *
 * @{
 */
 ...
 */
const char *epos_get_version_string(void);
