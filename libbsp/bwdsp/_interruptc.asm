...
_push_exit_r:
  ...
  [u8+ -7, 1] = xyztr1:0 || u8 = u8 + -8
//用v0保存B_Context的基址。
//B——Context的基址是一直不变的。但是由于需要在A的结构中保存该地址，所以，每次需要重新保存该地址
 ...
 v0 = xr0
  ...
  u8 = u8 + -7 || v0 = v0 + -7
//开始计算B——Context的大小  
  [u8 += -8, 1] = xyztr3:2 || [v0 += -8, 1] = xyztr1:0 <bb>  
  || xr0 = v8 || xr1 = v9        
  || yr0 = v10 || yr1 = v11
  || zr0 = v12 || zr1 = v13
  || tr0 = v14 || tr1 = v15
 
  [u8 += -8, 1] = xyztr5:4 || [v0 += -8, 1] = xyztr3:2 <bb>
  || xr0 = w0 <bb> || xr1 = w1 <bb>
  || yr0 = w2 <bb> || yr1 = w3 <bb>
  || zr0 = w4 <bb> || zr1 = w5 <bb>
  || tr0 = w6 <bb> || tr1 = w7 <bb>
  ...
  [u8 += -8, 1] = xyztr7:6 || [v0 += -8, 1] = xyztr5:4 <bb>
  || xr2 = w8 || xr3 = w9
  || yr2 = w10 || yr3 = w11
  || zr2 = w12 || zr3 = w13
  || tr2 = w14 || tr3 = w15
  ...
  [u8 += -8, 1] = xyztr9:8 || [v0 += -8, 1] = xyztr7:6 <bb>
  || xr2 = u0 <bb> || xr3 = u1 <bb>
  || yr2 = u2 <bb> || yr3 = u3 <bb>
  || zr2 = u4 <bb> || zr3 = u5 <bb>
  || tr2 = u6 <bb> || tr3 = u7 <bb>
  
  [u8 += -8, 1] = xyztr11:10 || [v0 += -8, 1] = xyztr9:8 <bb>
  ||  r4 = llomacc0(u, cut=0)
  ||  r5 = llomacc1(u, cut=0)
  ||  r6 = llomacc2(u, cut=0)
  ||  r7 = llomacc3(u, cut=0)
  ...
  [u8 += -8, 1] = xyztr13:12 || [v0 += -8, 1] = xyztr11:10 <bb>
  ...
  [u8 += -8,1] = xyztr15:14 || [v0 += -8,1] = xyztr13:12 <bb>
  ||  r8 = hlomacc0(u, cut=0)
  ||  r9 = hlomacc1(u, cut=0)
  ...
  [u8 += -8,1] = xyztr17:16 || [v0 += -8,1] = xyztr15:14 <bb>
  ...
  [u8 += -8,1] = xyztr19:18 || [v0 += -8,1] = xyztr17:16 <bb>
  ...
  [u8 += -8,1] = xyztr21:20 || [v0 += -8,1] = xyztr19:18 <bb>
  ...
  [u8 += -8,1] = xyztr23:22 || [v0 += -8,1] = xyztr21:20 <bb>
  ...
  [u8 += -8,1] = xyztr25:24 || [v0 += -8,1] = xyztr23:22 <bb>
  ...
  [u8 += -8,1] = xyztr27:26 || [v0 += -8,1] = xyztr25:24 <bb> || r20 = MULCUTR
  
  r20 = MULCR <bb>
  r21 = MULFR0  || r21 = MULFR1 <bb>
  || r22 = MULFR2  || r22 = MULFR3 <bb> 
  
  [u8 += -8, 1] = xyztr29:28 || [v0 += -8, 1] = xyztr27:26 <bb>
  || r23 = MULFR4  || r23 = MULFR5 <bb>
  || r24 = MULFR6  || r24 = MULFR7 <bb> 
  || r25 = SPUFR   || r25 = SPUCR <bb>

  
  [u8 += -8,1] = xyztr31:30 || [v0 += -8,1] = xyztr29:28 <bb> || r26 = SHFCUTR
  r26 = GPLYR32 <bb>
  r27 = SHFCR
  r27 = CPRED <bb>
  

  [u8 += -8, 1] = xyztr33:32 ||  [v0 += -8, 1] = xyztr31:30 <bb>
  || r28 = SHFFR0  || r28 = SHFFR1 <bb>
  || r29 = SHFFR2  || r29 = SHFFR3 <bb>
  
  [u8 += -8, 1] = xyztr35:34 || [v0 += -8, 1] = xyztr33:32 <bb>
  || r30 = SLTAR0  || r30 = SLTAR1 <bb>
  || r31 = SLTAR2  || r31 = SLTAR3 <bb>
  
  
  [u8 += -8, 1] = xyztr37:36 || [v0 += -8, 1] = xyztr35:34 <bb>
  || r32 = SCF0 || r32 = SCF1 <bb>
  || r33 = SCF2 || r33 = SCF3 <bb>
  

  [u8 += -8, 1] = xyztr39:38 || [v0 += -8, 1] = xyztr37:36 <bb>
  || r34 = SHFER0 || r34 = SHFER1 <bb>
  || r35 = SHFER2 || r35 = SHFER3 <bb>
  
  [u8 += -8, 1] = xyztr41:40 ||  [v0 += -8, 1] = xyztr39:38 <bb>
  [u8 += -8, 1] = xyztr43:42 ||  [v0 += -8, 1] = xyztr41:40 <bb>
  [u8 += -8, 1] = xyztr45:44 ||  [v0 += -8, 1] = xyztr43:42 <bb>
  [u8 += -8, 1] = xyztr47:46 ||  [v0 += -8, 1] = xyztr45:44 <bb>
  [u8 += -8, 1] = xyztr49:48 ||  [v0 += -8, 1] = xyztr47:46 <bb>
  [u8 += -8, 1] = xyztr51:50 ||  [v0 += -8, 1] = xyztr49:48 <bb>
  [u8 += -8, 1] = xyztr53:52 ||  [v0 += -8, 1] = xyztr51:50 <bb>
  [u8 += -8, 1] = xyztr55:54 ||  [v0 += -8, 1] = xyztr53:52 <bb>
  [u8 += -8, 1] = xyztr57:56 ||  [v0 += -8, 1] = xyztr55:54 <bb>
  [u8 += -8, 1] = xyztr59:58 ||  [v0 += -8, 1] = xyztr57:56 <bb>
  [u8 += -8, 1] = xyztr61:60 ||  [v0 += -8, 1] = xyztr59:58 <bb>
  [u8 += -8, 1] = xyztr63:62 ||  [v0 += -8, 1] = xyztr61:60 <bb>
								 [v0 += -8, 1] = xyztr63:62 <bb>
  ...
  [u8 += -8, 1] = xyztr1:0 ||  [v0 += -8, 1] = xyztr1:0 <bb>
  [u8 += -8, 1] = xyztr3:2 ||  [v0 += -8, 1] = xyztr3:2 <bb>
  [u8 += -8, 1] = xyztr5:4 ||  [v0 += -8, 1] = xyztr5:4 <bb>
  [u8 += -8, 1] = xyztr7:6 ||  [v0 += -8, 1] = xyztr7:6 <bb>
  [u8 += -8, 1] = xyztr9:8 ||  [v0 += -8, 1] = xyztr9:8 <bb>
  [u8 += -8, 1] = xyztr11:10 ||  [v0 += -8, 1] = xyztr11:10 <bb>
  [u8 += -8, 1] = xyztr13:12 ||  [v0 += -8, 1] = xyztr13:12 <bb>
  [u8 += -8, 1] = xyztr15:14 ||  [v0 += -8, 1] = xyztr15:14 <bb>
  [u8 += -8, 1] = xyztr17:16 ||  [v0 += -8, 1] = xyztr17:16 <bb>
  [u8 += -8, 1] = xyztr19:18 ||  [v0 += -8, 1] = xyztr19:18 <bb>
  [u8 += -8, 1] = xyztr21:20 ||  [v0 += -8, 1] = xyztr21:20 <bb>
  [u8 += -8, 1] = xyztr23:22 ||  [v0 += -8, 1] = xyztr23:22 <bb>
  [u8 += -8, 1] = xyztr25:24 ||  [v0 += -8, 1] = xyztr25:24 <bb>
  [u8 += -8, 1] = xyztr27:26 ||  [v0 += -8, 1] = xyztr27:26 <bb>
  [u8 += -8, 1] = xyztr29:28 ||  [v0 += -8, 1] = xyztr29:28 <bb>
  [u8 += -8, 1] = xyztr31:30 ||  [v0 += -8, 1] = xyztr31:30 <bb>
  [u8 += -8, 1] = xyztr33:32 ||  [v0 += -8, 1] = xyztr33:32 <bb>
  [u8 += -8, 1] = xyztr35:34 ||  [v0 += -8, 1] = xyztr35:34 <bb>
  [u8 += -8, 1] = xyztr37:36 ||  [v0 += -8, 1] = xyztr37:36 <bb>
  [u8 += -8, 1] = xyztr39:38 ||  [v0 += -8, 1] = xyztr39:38 <bb>
  [u8 += -8, 1] = xyztr41:40 ||  [v0 += -8, 1] = xyztr41:40 <bb>
  [u8 += -8, 1] = xyztr43:42 ||  [v0 += -8, 1] = xyztr43:42 <bb>
  [u8 += -8, 1] = xyztr45:44 ||  [v0 += -8, 1] = xyztr45:44 <bb>
  [u8 += -8, 1] = xyztr47:46 ||  [v0 += -8, 1] = xyztr47:46 <bb>
  [u8 += -8, 1] = xyztr49:48 ||  [v0 += -8, 1] = xyztr49:48 <bb>
  [u8 += -8, 1] = xyztr51:50 ||  [v0 += -8, 1] = xyztr51:50 <bb>
  [u8 += -8, 1] = xyztr53:52 ||  [v0 += -8, 1] = xyztr53:52 <bb>
  [u8 += -8, 1] = xyztr55:54 ||  [v0 += -8, 1] = xyztr55:54 <bb>
  [u8 += -8, 1] = xyztr57:56 ||  [v0 += -8, 1] = xyztr57:56 <bb>
  [u8 += -8, 1] = xyztr59:58 ||  [v0 += -8, 1] = xyztr59:58 <bb>
  [u8 += -8, 1] = xyztr61:60 ||  [v0 += -8, 1] = xyztr61:60 <bb>
  [u8 += -8, 1] = xyztr63:62 ||  [v0 += -8, 1] = xyztr63:62 <bb>
...
//if xr0 != r1 b _intr_no_swir
  ...
  w0 = xr1
  xr0 = [w0+0,0]  //取出_current_stack_base的值（即一个地址），放到xr0中
  [u8 + 0, 0] = xr0//将_current_stack_base的值压栈
  u8 = u8 + -1
...
_exitme:
  ...
  xr0 = [u8+1,0]
  xr1 = _context_B_base  //将栈中保存的B部分的基址存到全局变量中，为了在保存上下文的时候直接从这个全局变量中取得B部分的基址
  v0 = xr1
  [v0+0,0] = xr0
  u8 = u8 + 1
...
//_exitme:
  ...
  xr0 = [w0+0,0]    //访问_context_B_base这个地址中存储的值，它是context B的基址
  xr0 -= 0x267
  v0 = xr0  //使v0指向B部分的栈顶，不是下一个位置
  
  //恢复ALUCR,ABFPR,BA,SR, BA,SR,IMACR,SER,LC

  xyztr1:0 = [u8 += 8, 1] || xyztr1:0 = [v0 += 8, 1] <bb> 
  ...
  //恢复ACC ALUFR
  xyztr7:6 = [u8 += 8, 1] ||  xyztr7:6 = [v0 += 8, 1] <bb>
  xyztr5:4 = [u8 += 8, 1] ||  xyztr5:4 = [v0 += 8, 1] <bb>
  xyztr3:2 = [u8 += 8, 1] ||  xyztr3:2 = [v0 += 8, 1] <bb> 
  xyztr1:0 = [u8 += 8, 1] ||  xyztr1:0 = [v0 += 8, 1] <bb>
  ...
  xyztr63:62 = [u8 += 8, 1] ||  xyztr63:62 = [v0 += 8, 1] <bb>
  xyztr61:60 = [u8 += 8, 1] ||  xyztr61:60 = [v0 += 8, 1] <bb>
  xyztr59:58 = [u8 += 8, 1] ||  xyztr59:58 = [v0 += 8, 1] <bb>
  xyztr57:56 = [u8 += 8, 1] ||  xyztr57:56 = [v0 += 8, 1] <bb>
  xyztr55:54 = [u8 += 8, 1] ||  xyztr55:54 = [v0 += 8, 1] <bb>
  xyztr53:52 = [u8 += 8, 1] ||  xyztr53:52 = [v0 += 8, 1] <bb>
  xyztr51:50 = [u8 += 8, 1] ||  xyztr51:50 = [v0 += 8, 1] <bb>
  xyztr49:48 = [u8 += 8, 1] ||  xyztr49:48 = [v0 += 8, 1] <bb>
  xyztr47:46 = [u8 += 8, 1] ||  xyztr47:46 = [v0 += 8, 1] <bb>
  xyztr45:44 = [u8 += 8, 1] ||  xyztr45:44 = [v0 += 8, 1] <bb>
  xyztr43:42 = [u8 += 8, 1] ||  xyztr43:42 = [v0 += 8, 1] <bb>
  xyztr41:40 = [u8 += 8, 1] ||  xyztr41:40 = [v0 += 8, 1] <bb>
  xyztr39:38 = [u8 += 8, 1] ||  xyztr39:38 = [v0 += 8, 1] <bb>
  xyztr37:36 = [u8 += 8, 1] ||  xyztr37:36 = [v0 += 8, 1] <bb>
  xyztr35:34 = [u8 += 8, 1] ||  xyztr35:34 = [v0 += 8, 1] <bb>
  xyztr33:32 = [u8 += 8, 1] ||  xyztr33:32 = [v0 += 8, 1] <bb>
  xyztr31:30 = [u8 += 8, 1] ||  xyztr31:30 = [v0 += 8, 1] <bb>
  xyztr29:28 = [u8 += 8, 1] ||  xyztr29:28 = [v0 += 8, 1] <bb>
  xyztr27:26 = [u8 += 8, 1] ||  xyztr27:26 = [v0 += 8, 1] <bb>
  xyztr25:24 = [u8 += 8, 1] ||  xyztr25:24 = [v0 += 8, 1] <bb>
  xyztr23:22 = [u8 += 8, 1] ||  xyztr23:22 = [v0 += 8, 1] <bb>
  xyztr21:20 = [u8 += 8, 1] ||  xyztr21:20 = [v0 += 8, 1] <bb>
  xyztr19:18 = [u8 += 8, 1] ||  xyztr19:18 = [v0 += 8, 1] <bb>
  xyztr17:16 = [u8 += 8, 1] ||  xyztr17:16 = [v0 += 8, 1] <bb>
  xyztr15:14 = [u8 += 8, 1] ||  xyztr15:14 = [v0 += 8, 1] <bb>
  xyztr13:12 = [u8 += 8, 1] ||  xyztr13:12 = [v0 += 8, 1] <bb>
  xyztr11:10 = [u8 += 8, 1] ||  xyztr11:10 = [v0 += 8, 1] <bb>
  xyztr9:8 = [u8 += 8, 1] ||  xyztr9:8 = [v0 += 8, 1] <bb>
  xyztr7:6 = [u8 += 8, 1] ||  xyztr7:6 = [v0 += 8, 1] <bb>
  xyztr5:4 = [u8 += 8, 1] ||  xyztr5:4 = [v0 += 8, 1] <bb>
  xyztr3:2 = [u8 += 8, 1] ||  xyztr3:2 = [v0 += 8, 1] <bb>
  xyztr1:0 = [u8 += 8, 1] ||  xyztr1:0 = [v0 += 8, 1] <bb>
