...
)
{
   ...
   *  routine is invoked from epos_rate_monotonic_period, the owner will
...
)
{
  ...
  epos_rate_monotonic_period_states   local_state;
  ISR_Level                            level;
