...
const epos_filesystem_operations_table  miniIMFS_ops = {
  IMFS_eval_path,
...
int miniIMFS_initialize(
  epos_filesystem_mount_table_entry_t *temp_mt_entry,
  const void                           *data
)
{
    return IMFS_initialize_support(
      temp_mt_entry,
      &miniIMFS_ops,
      &epos_filesystem_null_handlers,  /* for memfiles */
      &epos_filesystem_null_handlers   /* for directories */
   );
}
