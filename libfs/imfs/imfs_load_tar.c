 ...
 *  @ingroup EposIMFS
 *
 *  @brief This file implements the "mount" procedure for tar-based IMFS extensions.
 */
...
{
   epos_filesystem_location_info_t  root_loc;
   ...
   while (1) {
    ...
    hdr_chksum = octal2ulong(&hdr_ptr[148], 8);
