...
)
{
  ...
  dev = epos_filesystem_make_dev_t( major, minor );
...
)
{
  ...
  int                                result;
  epos_filesystem_node_types_t      node_type;

  result = epos_filesystem_evaluate_path( name, strlen( name ), 0x00, &loc, true );
