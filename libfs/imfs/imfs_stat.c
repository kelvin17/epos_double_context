 ...
 *  @ingroup EposIMFS
 *
 *  @brief This routine provides a stat for the IMFS file system.
 */
...
)
{
  ...
  switch ( the_jnode->type ) {
    ...
    case IMFS_DEVICE:
      ...
      buf->st_rdev = epos_filesystem_make_dev_t( io->major, io->minor );
      break;
  ...
  buf->st_dev =
    epos_filesystem_make_dev_t( IMFS_DEVICE_MAJOR_NUMBER, fs_info->instance );
