...
)
{
  ...
  printk( "timer_initiate_server -- INVALID_PRIORITY" );
  ...
  fatal_directive_status(
    ...
    "epos_timer_initiate_server bad priority"
  );

  printk( "timer_initiate_server -- OK" );
  status = epos_timer_initiate_server(
  ...
  printk( "timer_initiate_server -- already started" );
  status = epos_timer_initiate_server(
    RTEMS_TIMER_SERVER_DEFAULT_PRIORITY,
    RTEMS_MINIMUM_STACK_SIZE,
    RTEMS_DEFAULT_ATTRIBUTES
  ...
  fatal_directive_status(
    ...
    "epos_timer_initiate_server already started"
  );
