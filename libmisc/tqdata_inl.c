 ...
 *  @file  tqdata.inl
 *
 *  @ingroup ScoreThreadQData
 *
 *  @brief The include file of the Thread Queue Data.
 *
...
# error "Never use "tqdata.inl" directly; include "tqdata.h" instead."
#endif
